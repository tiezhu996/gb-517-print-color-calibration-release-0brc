...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput), errors.Is(err, service.ErrDriftBlocked):
	...
	case errors.Is(err, service.ErrLocked), errors.Is(err, service.ErrProofSuperseded):
